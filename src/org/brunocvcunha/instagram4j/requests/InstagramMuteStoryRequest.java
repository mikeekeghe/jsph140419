...
@AllArgsConstructor
@Log4j
public class InstagramMuteStoryRequest extends InstagramPostRequest<InstagramPostCommentResult> {
    ...
    public String getPayload() {
        ...
        try {
            ...
            Logger.getLogger(InstagramMuteStoryRequest.class.getName()).log(Level.SEVERE, null, ex);
        }
